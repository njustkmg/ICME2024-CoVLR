...
class RobertaLMHead(nn.Module):
    ...
    def __init__(self, config):
        super().__init__()
        self.dense = LinearML(config.hidden_size, config.hidden_size)
        self.layer_norm = LayerNormML(config.hidden_size, eps=config.layer_norm_eps)

        self.decoder = LinearML(config.hidden_size, config.vocab_size)
...
class RobertaClassificationHead(nn.Module):
    ...
    def __init__(self, config):
        ...
        self.dropout = nn.Dropout(classifier_dropout)
        self.out_proj = LinearML(config.hidden_size, config.num_labels)
